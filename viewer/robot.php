...
if (null === $item = $services['app.repository.item_model']->findRobot($itemId)) {
    die(sprintf('Robot #%d not found.', $itemId));
}
...
<script type="text/javascript">
    ...
    viewer.setParameter('SceneUrl', 'robots/robot<?=$model->getSceneUrl("", "")?>');
